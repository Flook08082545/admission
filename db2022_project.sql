...
--
-- Host: localhost
-- Generation Time: Apr 06, 2023 at 04:18 AM
...
--
-- Database: `db2022_project`
--

-- --------------------------------------------------------

--
-- Table structure for table `adress_nation`
--

CREATE TABLE `adress_nation` (
  `address_id` int(11) NOT NULL,
  `national_id` bigint(13) NOT NULL,
...
--
-- Dumping data for table `adress_nation`
--

INSERT INTO `adress_nation` (`address_id`, `national_id`, `house_number`, `street`, `group`, `province`, `district`, `sub_district`, `post_code`) VALUES
(112, 1100801436831, 11, '-', 11, 16, 195, 250704, 25130),
(113, 1470401277459, 11, '-', 11, 9, 120, 180602, 17130),
(114, 1100000, 11, '-', 11, 3, 62, 120503, 11150),
(115, 5555555, 11, '-', 11, 16, 191, 250303, 25220),
(116, 79879, 11, '-', 11, 26, 382, 370303, 37110);
...
CREATE TABLE `applications` (
  ...
  `prefix_th` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `fname_th` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `lname_th` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `prefix_en` varchar(5) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `fname_en` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `lname_en` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `bday` date NOT NULL,
  ...
  `religion` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `telephone_number` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `telephone_home` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `email` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `parents_occupation` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `income_parents` int(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `applications` (`app_id`, `national_id`, `tcas_round`, `prefix_th`, `fname_th`, `lname_th`, `prefix_en`, `fname_en`, `lname_en`, `bday`, `ethnicity`, `nationality`, `religion`, `telephone_number`, `telephone_home`, `email`, `parents_occupation`, `income_parents`) VALUES
(119, 1100801436831, 4, 'นาย', 'Jetsadakorn', 'Pamaprai', 'Mr.', 'Jetsadakorn', 'Pamaprai', '2023-03-17', 'ไทย', 'ไทย', 'พุทธ', '0982276819', '0982276819', 'flook0961458054.f@gmail.com', 'หฟก', 200000),
(120, 1470401277459, 1, 'นาย', 'Pariwat', 'Wongkhemma', 'Mr.', 'Pariwat', 'Wongkhemma', '2023-03-19', 'ไทย', 'ไทย', 'พุทธ', '0982276819', '0982276819', 'flook0961458054.f@gmail.com', 'หฟก', 200000),
(121, 1100000, 1, 'นาย', 'Jetsadakorn', 'Pamaprai', 'Mr.', 'Jetsadakorn', 'Pamaprai', '2023-03-03', 'ไทย', 'ไทย', 'พุทธ', '0982276819', '0982276819', 'flook0961458054.f@gmail.com', 'หฟก', 200000),
(122, 5555555, 1, 'นาย', 'Jetsadakorn', 'Pamaprai', 'Mr.', 'Jetsadakorn', 'Pamaprai', '2023-03-10', 'ไทย', 'ไทย', 'พุทธ', '0982276819', '0982276819', 'flook0961458054.f@gmail.com', 'หฟก', 200000),
(123, 79879, 2, 'นาย', 'เจษฎากร', 'ป่ามะไพร', 'Mr.', 'Jetsadakorn', 'Pamaprai', '2023-04-04', 'ไทย', 'ไทย', 'พุทธ', '0982276819', '0982276819', 'flook0961458054.f@gmail.com', 'หฟก', 200000),
(124, 1, 1, '1', '1', '1', '1', '1', '1', '2023-04-08', '1', '1', '1', '1', '1', '1', '1', 1);
...
CREATE TABLE `educational_qualification` (
  ...
  `education_type` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `educational_qualification` (`education_id`, `education_type`) VALUES
(1, 'ม.6'),
(2, 'ปวช.');
...
CREATE TABLE `education_student` (
  ...
  `education_qualification` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `study_plan` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `average_GPA` float NOT NULL,
  `major_id` int(10) NOT NULL,
  `file` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `province_of_school` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `district_of_school` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `subdistrict_of_school` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
INSERT INTO `education_student` (`education_id`, `national_id`, `school`, `education_qualification`, `study_plan`, `average_GPA`, `major_id`, `file`, `province_of_school`, `district_of_school`, `subdistrict_of_school`, `zip_code`) VALUES
(182, 1100801436831, 'โรงเรียนธาตุนารายณ์วิทยา', '1', '70', 4, 1, '20230404-202358.pdf', '4\n    ', '69', '130402', 12170);

-- --------------------------------------------------------

--
-- Table structure for table `education_student_round2`
--

CREATE TABLE `education_student_round2` (
  `education_id` int(11) NOT NULL,
  `national_id` bigint(13) NOT NULL,
  `school` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `education_qualification` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `study_plan` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `average_GPA` float NOT NULL,
  `major_id_1` int(10) NOT NULL,
  `major_id_2` int(10) NOT NULL,
  `major_id_3` int(10) NOT NULL,
  `major_id_4` int(10) NOT NULL,
  `file` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `province_of_school` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `district_of_school` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `subdistrict_of_school` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
--
-- Dumping data for table `education_student_round2`
--

INSERT INTO `education_student_round2` (`education_id`, `national_id`, `school`, `education_qualification`, `study_plan`, `average_GPA`, `major_id_1`, `major_id_2`, `major_id_3`, `major_id_4`, `file`, `province_of_school`, `district_of_school`, `subdistrict_of_school`, `zip_code`) VALUES
(20, 1100801436831, 'โรงเรียนธาตุนารายณ์วิทยา', '1', '2', 4, 15, 22, 23, 22, '20230405-232934.pdf', '21', '277', '320504', 32140);

-- --------------------------------------------------------

--
-- Table structure for table `education_student_round4`
--

CREATE TABLE `education_student_round4` (
  `education_id` int(11) NOT NULL,
  `national_id` bigint(13) NOT NULL,
  `school` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `education_qualification` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  ...
  `major_id` int(10) NOT NULL,
  `file` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `province_of_school` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `district_of_school` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `subdistrict_of_school` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `zip_code` int(5) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `education_student_round4`
--

INSERT INTO `education_student_round4` (`education_id`, `national_id`, `school`, `education_qualification`, `study_plan`, `average_GPA`, `major_id`, `file`, `province_of_school`, `district_of_school`, `subdistrict_of_school`, `zip_code`) VALUES
(13, 1100801436831, 'โรงเรียนธาตุนารายณ์วิทยา', '2', '37', 4, 17, '20230405-233954.pdf', '8', '111', '170302', 16150);
...
INSERT INTO `group` (`group_id`, `group`) VALUES
(1, 'คณะทรัพยากรฑรรมชาติและอุตสาหกรรม'),
...
INSERT INTO `major` (`major_id`, `group_id`, `major`, `grade`) VALUES
(1, 1, 'เทคโนโลยีการอาหาร', 2),
(2, 1, 'พืชศาสตร์', 2),
(3, 1, 'อาหารปลอดภัยและโภชนาการ', 2),
(4, 1, 'ทรัพยากรเกษตรและการจัดการผลิต', 2),
(5, 1, 'ประมง', 2),
(6, 1, 'สัตวศาสตร์', 2),
(7, 2, 'วิศวกรรมเครื่องกลและการผลิต', 2),
(8, 2, 'วิศวกรรมไฟฟ้า', 2.5),
(9, 2, 'วิศวกรรมโยธา', 2.75),
(10, 2, 'เคมีประยุกต์', 2),
(11, 2, 'วิทยาการคอมพิวเตอร์', 2),
(12, 2, 'วิศวกรรมคอมพิวเตอร์', 2.5),
(13, 2, 'วิศวกรรมอุตสาหการ', 2),
(14, 2, 'วิศวกรรมสิ่งแวดล้อมเพื่อการพัฒนาอย่างยั่งยืน', 2),
(15, 3, 'การจัดการ', 2),
(16, 3, 'การบัญชี', 2),
(17, 3, 'การตลาด', 2),
(18, 3, 'การจัดการอุตสาหกรรมการบริการ', 2),
(19, 3, 'ภาษาอังกฤษ', 2),
(20, 3, 'การเงิน', 2),
(21, 3, 'นิติศาสตร์', 2),
(22, 3, 'รัฐประศาสนศาสตร์', 2),
(23, 4, 'สาธารณสุขศาสตร์', 3.25),
(24, 4, 'อนามัยสิ่งแวดล้อม', 2.5),
(25, 4, 'อาชีวอนามัยและความปลอดภัย', 3.25);
...
--
-- Table structure for table `stady_plan`
--

CREATE TABLE `stady_plan` (
  `stady_plan_id` int(11) NOT NULL,
  `education_id` int(10) NOT NULL,
  `stady_plan` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `stady_plan`
--

INSERT INTO `stady_plan` (`stady_plan_id`, `education_id`, `stady_plan`) VALUES
(1, 1, 'วิทย์-คณิต'),
(2, 1, 'วิทย์-ศิลป์'),
(37, 2, 'อาชีวศึกษา'),
(40, 1, 'วิทย์-คอม'),
...
--
-- Indexes for table `adress_nation`
--
ALTER TABLE `adress_nation`
...
--
-- Indexes for table `education_student_round2`
--
ALTER TABLE `education_student_round2`
  ADD PRIMARY KEY (`education_id`);

--
-- Indexes for table `education_student_round4`
--
ALTER TABLE `education_student_round4`
  ADD PRIMARY KEY (`education_id`);
...
--
-- Indexes for table `stady_plan`
--
ALTER TABLE `stady_plan`
  ADD PRIMARY KEY (`stady_plan_id`);
...
--
-- AUTO_INCREMENT for table `adress_nation`
--
ALTER TABLE `adress_nation`
...
--
-- AUTO_INCREMENT for table `education_student`
--
ALTER TABLE `education_student`
  MODIFY `education_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=183;

--
-- AUTO_INCREMENT for table `education_student_round2`
--
ALTER TABLE `education_student_round2`
  MODIFY `education_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT for table `education_student_round4`
--
ALTER TABLE `education_student_round4`
...
--
ALTER TABLE `major`
  MODIFY `major_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
-- AUTO_INCREMENT for table `stady_plan`
--
ALTER TABLE `stady_plan`
  MODIFY `stady_plan_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=71;
COMMIT;
